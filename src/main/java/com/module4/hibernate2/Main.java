package com.module4.hibernate2;

import com.module4.hibernate2.dao.*;
import com.module4.hibernate2.domain.*;
...
public class Main {
    ...
    private Customer createCustomer() {
        try(Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setDistrict("Muhosralskiy rayon");
            ...
            customer.setEmail("none@none.net");
